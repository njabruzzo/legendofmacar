...
assert(/ASSET_VER='116'/.test(html) && !/ASSET_VER='117'/.test(html),
  'ASSET_VER is 116 — remat Talpor idle bw=344 (Nick CALL)');
...
assert(/href="assets\/ui\/title_menu\.jpg\?v=116"/.test(html),
  'title_menu preload matches ASSET_VER 116');
