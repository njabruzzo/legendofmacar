...
assert(/ASSET_VER='113'/.test(html) && !/ASSET_VER='114'/.test(html),
  'ASSET_VER is 113 — ghost spectral walk v7 (Nick Good)');
...
assert(/href="assets\/ui\/title_menu\.jpg\?v=113"/.test(html),
  'title_menu preload matches ASSET_VER 113');
