...
assert(/ASSET_VER='120'/.test(html), 'ASSET_VER is 117');
assert(!/ASSET_VER='100'/.test(html) && !/ASSET_VER='101'/.test(html) && !/ASSET_VER='102'/.test(html), 'ASSET_VER is not leftover 100/101/102');
